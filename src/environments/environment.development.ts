export const environment = {
  ...
  rest_api: {
    ...
    keycloak: {
      ...
      create: "https://api-gateway.bawaslu.go.id/api/v1/backoffice/superuser/users",
      delete: "https://api-gateway.bawaslu.go.id/api/v1/backoffice/superuser/users/",
      update: "https://api-gateway.bawaslu.go.id/api/v1/backoffice/superuser/users/update/",
