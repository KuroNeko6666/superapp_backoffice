...
@Component({
  selector: 'app-print-activity',
  templateUrl: './print-activity.component.html',
  styleUrls: ['./print-activity.component.css']
})
export class PrintActivityComponent {
  ...
  ngOnInit(): void{
    this.service.get_activity().subscribe({
      next: (value) => {
        console.log(value);
